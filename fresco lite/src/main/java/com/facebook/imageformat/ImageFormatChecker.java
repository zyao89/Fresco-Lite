...
public class ImageFormatChecker
{
     ...
     */
    private static final int MAX_HEADER_LENGTH = Ints.max(EXTENDED_WEBP_HEADER_LENGTH, SIMPLE_WEBP_HEADER_LENGTH, JPEG_HEADER.length, PNG_HEADER.length, GIF_HEADER_LENGTH, BMP_HEADER.length);
     ...
     */
    private static ImageFormat doGetImageFormat (final byte[] imageHeaderBytes, final int headerSize)
    {
     ...
     * @throws IOException
     */
    private static int readHeaderFromStream (final InputStream is, final byte[] imageHeaderBytes) throws IOException
    {
