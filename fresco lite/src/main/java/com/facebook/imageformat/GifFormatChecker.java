...
public final class GifFormatChecker
{
     ...
     */
    private static final byte[] FRAME_HEADER_START = new byte[]{(byte) 0x00, (byte) 0x21, (byte) 0xF9, (byte) 0x04};
    /**
     * Every GIF frame header ends with a 2 byte static sequence consisting of one of
     * the following two sequences of bytes
     */
    private static final byte[] FRAME_HEADER_END_1 = new byte[]{(byte) 0x00, (byte) 0x2C};
    private static final byte[] FRAME_HEADER_END_2 = new byte[]{(byte) 0x00, (byte) 0x21};
