...
public class BitmapMemoryCacheKey implements CacheKey
{
    ...
    private final
    @Nullable
    CacheKey mPostprocessorCacheKey;
    private final
    @Nullable
    String mPostprocessorName;
    ...
    public BitmapMemoryCacheKey (String sourceString, @Nullable ResizeOptions resizeOptions, boolean autoRotated, ImageDecodeOptions imageDecodeOptions, @Nullable CacheKey postprocessorCacheKey, @Nullable String postprocessorName, Object callerContext)
    {
        ...
        mHash = HashCodeUtil.hashCode(sourceString.hashCode(), (resizeOptions != null) ? resizeOptions.hashCode() : 0, autoRotated ? Boolean.TRUE.hashCode() : Boolean.FALSE.hashCode(), mImageDecodeOptions, mPostprocessorCacheKey, postprocessorName);
    ...
    {
        return String.format((Locale) null, "%s_%s_%s_%s_%s_%s_%d", mSourceString, mResizeOptions, Boolean.toString(mAutoRotated), mImageDecodeOptions, mPostprocessorCacheKey, mPostprocessorName, mHash);
    }
