...
public class FlexByteArrayPool
{
    ...
    public FlexByteArrayPool (MemoryTrimmableRegistry memoryTrimmableRegistry, PoolParams params)
    {
        ...
        mDelegatePool = new SoftRefByteArrayPool(memoryTrimmableRegistry, params, NoOpPoolStatsTracker.getInstance());
    ...
    static class SoftRefByteArrayPool extends GenericByteArrayPool
    {
        ...
        {
            return new OOMSoftReferenceBucket<>(getSizeInBytes(bucketedSize), mPoolParams.maxNumThreads, 0);
        }
    }
}
