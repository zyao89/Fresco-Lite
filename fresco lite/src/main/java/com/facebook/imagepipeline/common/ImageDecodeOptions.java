...
public class ImageDecodeOptions
{
    ...
    public boolean equals (Object o)
    {
        ...
        return forceStaticImage == that.forceStaticImage;
    ...
    {
        return String.format((Locale) null, "%d-%b-%b-%b-%b", minDecodeIntervalMs, decodePreviewFrame, useLastFrameForPreview, decodeAllFrames, forceStaticImage);
    }
}
