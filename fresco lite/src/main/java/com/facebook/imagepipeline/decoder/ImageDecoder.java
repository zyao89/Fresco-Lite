...
public class ImageDecoder
{
    ...
    public ImageDecoder (final AnimatedImageFactory animatedImageFactory, final PlatformDecoder platformDecoder, final Bitmap.Config bitmapConfig)
    {
     ...
     */
    public CloseableImage decodeImage (final EncodedImage encodedImage, final int length, final QualityInfo qualityInfo, final ImageDecodeOptions options)
    {
    ...
    public CloseableImage decodeGif (EncodedImage encodedImage, ImageDecodeOptions options)
    {
        ...
        try
        {
            if (!options.forceStaticImage && mAnimatedImageFactory != null && GifFormatChecker.isAnimated(is))
            {
    ...
    {
        CloseableReference<Bitmap> bitmapReference = mPlatformDecoder.decodeFromEncodedImage(encodedImage, mBitmapConfig);
        try
        {
    ...
    {
        CloseableReference<Bitmap> bitmapReference = mPlatformDecoder.decodeJPEGFromEncodedImage(encodedImage, mBitmapConfig, length);
        try
        {
     ...
     */
    public CloseableImage decodeAnimatedWebp (final EncodedImage encodedImage, final ImageDecodeOptions options)
    {
