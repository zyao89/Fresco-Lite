...
public class ResizeAndRotateProducer implements Producer<EncodedImage>
{
    ...
    private class TransformingConsumer extends DelegatingConsumer<EncodedImage, EncodedImage>
    {
        ...
        public TransformingConsumer (final Consumer<EncodedImage> consumer, final ProducerContext producerContext)
        {
            super(consumer);
            mIsCancelled = false;
        ...
        private void doTransform (EncodedImage encodedImage, boolean isLast)
        {
            ...
            try
            {
                ...
                JpegTranscoder.transcodeJpeg(is, outputStream, getRotationAngle(imageRequest, encodedImage), numerator, DEFAULT_JPEG_QUALITY);
        ...
        private Map<String, String> getExtraMap (EncodedImage encodedImage, ImageRequest imageRequest, int numerator)
        {
            ...
            return ImmutableMap.of(ORIGINAL_SIZE_KEY, originalSize, REQUESTED_SIZE_KEY, requestedSize, FRACTION_KEY, fraction, JobScheduler.QUEUE_TIME_KEY, String.valueOf(mJobScheduler.getQueuedTime()));
        }
    }
}
