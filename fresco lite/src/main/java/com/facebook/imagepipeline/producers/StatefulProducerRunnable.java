...
public abstract class StatefulProducerRunnable<T> extends StatefulRunnable<T>
{
    ...
    {
        mProducerListener.onProducerFinishWithSuccess(mRequestId, mProducerName, mProducerListener.requiresExtraMap(mRequestId) ? getExtraMapOnSuccess(result) : null);
    ...
    {
        mProducerListener.onProducerFinishWithFailure(mRequestId, mProducerName, e, mProducerListener.requiresExtraMap(mRequestId) ? getExtraMapOnFailure(e) : null);
    ...
    {
        mProducerListener.onProducerFinishWithCancellation(mRequestId, mProducerName, mProducerListener.requiresExtraMap(mRequestId) ? getExtraMapOnCancellation() : null);
