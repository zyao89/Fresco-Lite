...
public class DecodeProducer implements Producer<CloseableReference<CloseableImage>>
{
    ...
    public DecodeProducer (final ByteArrayPool byteArrayPool, final Executor executor, final ImageDecoder imageDecoder, final ProgressiveJpegConfig progressiveJpegConfig, final boolean downsampleEnabled, final boolean downsampleEnabledForNetwork, final Producer<EncodedImage> inputProducer)
    {
    ...
    public void produceResults (final Consumer<CloseableReference<CloseableImage>> consumer, final ProducerContext producerContext)
    {
        ...
        else
        {
            ...
            progressiveDecoder = new NetworkImagesProgressiveDecoder(consumer, producerContext, jpegParser, mProgressiveJpegConfig);
        }
    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>>
    {
        ...
        public ProgressiveDecoder (final Consumer<CloseableReference<CloseableImage>> consumer, final ProducerContext producerContext)
        {
            super(consumer);
        ...
        private Map<String, String> getExtraMap (@Nullable CloseableImage image, long queueTime, QualityInfo quality, boolean isFinal)
        {
            ...
            if (image instanceof CloseableStaticBitmap)
            {
                ...
                return ImmutableMap.of(BITMAP_SIZE_KEY, sizeStr, JobScheduler.QUEUE_TIME_KEY, queueStr, HAS_GOOD_QUALITY_KEY, qualityStr, IS_FINAL_KEY, finalStr, IMAGE_TYPE_KEY, cacheChoiceStr);
            }
            else
            {
                return ImmutableMap.of(JobScheduler.QUEUE_TIME_KEY, queueStr, HAS_GOOD_QUALITY_KEY, qualityStr, IS_FINAL_KEY, finalStr, IMAGE_TYPE_KEY, cacheChoiceStr);
            }
        }
    ...
    private class LocalImagesProgressiveDecoder extends ProgressiveDecoder
    {
        ...
        public LocalImagesProgressiveDecoder (final Consumer<CloseableReference<CloseableImage>> consumer, final ProducerContext producerContext)
        {
    ...
    private class NetworkImagesProgressiveDecoder extends ProgressiveDecoder
    {
        ...
        public NetworkImagesProgressiveDecoder (final Consumer<CloseableReference<CloseableImage>> consumer, final ProducerContext producerContext, final ProgressiveJpegParser progressiveJpegParser, final ProgressiveJpegConfig progressiveJpegConfig)
        {
            super(consumer, producerContext);
        ...
        protected synchronized boolean updateDecodeJob (EncodedImage encodedImage, boolean isLast)
        {
            ...
            if (!isLast && EncodedImage.isValid(encodedImage))
            {
                ...
                if (scanNum <= mLastScheduledScanNumber || scanNum < mProgressiveJpegConfig.getNextScanNumberToDecode(mLastScheduledScanNumber))
                {
                    return false;
                }
