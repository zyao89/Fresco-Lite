...
public abstract class AbstractDataSource<T> implements DataSource<T>
{
    ...
    private void notifyDataSubscriber (final DataSubscriber<T> dataSubscriber, final Executor executor, final boolean isFailure, final boolean isCancellation)
    {
     ...
     * data source will be set to {@link DataSourceStatus#SUCCESS}.
     * <p>
