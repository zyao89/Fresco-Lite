...
{
    public static final boolean sIsWebpSupportRequired = Build.VERSION.SDK_INT <= Build.VERSION_CODES.JELLY_BEAN_MR1;

    public static final boolean sIsSimpleWebpSupported = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH;
    /**
     * BASE64 encoded extended WebP image.
     */
    private static final String VP8X_WEBP_BASE64 = "UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAw" + "AAAARBxAR/Q9ERP8DAABWUDggGAAAABQBAJ0BKgEAAQAAAP4AAA3AAP7mtQAAAA==";
    ...
    public static boolean isWebpPlatformSupported (final byte[] imageHeaderBytes, final int offset, final int headerSize)
    {
    ...
    {
        return headerSize >= EXTENDED_WEBP_HEADER_LENGTH && matchBytePattern(imageHeaderBytes, offset + 12, WEBP_VP8X_BYTES);
    }
